      ...
      <Grid container spacing={2} alignItems="center">
        ...
        <Grid item xs={12} md={6}>
          ...
          <Typography
            ...
            kişiselleştirilmiş sağlık hizmetleri. Uzman doktorlarımız çevrimiçi
            konsültasyonlar sunar ve refahınıza öncelik veren özel hizmetler.
            Bize katılın daha sağlıklı bir size doğru bu yolculuk.
          </Typography>
          <Typography
            variant="h4"
            sx={{
          ...
          {steps.map((step, index) => (
            <Box
              ...
              <CheckCircleOutlineIcon
                sx={{ color: '#9D2553', marginRight: '12px' }}
              />
              <Box>
                <Typography
                  variant="h6"
